...
russianMessage (TimeAboutHoursAgo time)        = "примерно " `mappend` pluralCountRu time RuWordHour `mappend` ruAgo
russianMessage (TimeAt time)                   = time
...
russianMessage (TimeOnYear time)               = time
